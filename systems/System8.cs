...
public class System8 : SystemBase {
    ...
    public override void CPUStep() {
        ...
        Console.WriteLine("System: " + $"opcode {Utils.ToHex(opcode)} : {programCounter} : {Utils.ToHex(opcode & 0xF000)} : {Utils.ToHex(opcode & 0xF00F)} : {Utils.ToHex(opcode & 0xF0FF)}");
