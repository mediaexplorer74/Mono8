...
namespace GameManager
{
    ...
    */
    ...
    public class Game1 : Game
    {
        ...
        // Paths
        public string romPath = "TETRIS.ch8";
        ...
        public Game1()
        {
            ...
            switch (ext)
            {
                ...
                default:
                    ...
                    Debug.WriteLine($"Info: CHIP-8 roms must end in .ch8 or .chip8! Right now we only support System 8! File extensions determine what 'system' to load!");
        ...
        protected override void Initialize()
        {
            ...
            Debug.WriteLine($"Rom Size:  {Utils.GetFileSize(romPath)}k");
            Debug.WriteLine("\n");
